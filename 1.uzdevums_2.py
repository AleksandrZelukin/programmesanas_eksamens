# 1.1. Uzrakstīt programmas koda bloku, 
# kas definē piemērotu klasi informācijai par
# transportlīdzekļiem CSDD datubāzē atbilstoši zemāk norādītajai informācijai, 
# kā arī definēt šai
...
# – zīmols, modelis, reģistrācijas datums CSDD
# datubāzē formātā dd.mm.gggg, pilna masa kilogramos (bez mērvienības), 
# degvielas veida
# apzīmējums (iespējamie apzīmējumi: 
# B – benzīns, 
# BG – benzīns/gāze, 
# D – dīzeļdegviela,
# E – elektriskais, 
